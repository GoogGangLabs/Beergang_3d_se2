...
const BarelyInStock = (props: Props) => {
  ...
  return (
    <div className="mt-[clamp(40px,11.111vw,68px)] pad:mt-[clamp(68px,6.296vw,71px)] desktop:mt-[clamp(71px,3.698vw,100vw)]">
      <div className="flex justify-center items-center skew-x-[-5deg] font-bold text-black bg-gradient-to-l from-[#860000] to-[#F52C00] text-[clamp(10px,2.778vw,14px)] pad:text-[clamp(14px,1.296vw,20px)] desktop:text-[clamp(20px,1.042vw,100vw)] w-[clamp(95px,26.389vw,148.81px)] pad:w-[clamp(148.81px,7.5vw,204.37px)] desktop:w-[clamp(204.37px,10.644vw,100vw)] aspect-[204.37/34] font-exo">
