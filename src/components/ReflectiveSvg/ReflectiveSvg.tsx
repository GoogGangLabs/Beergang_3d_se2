...
export interface SvgProps extends Omit<Object3DProps, "ref"> {
  ...
  skipFill?: boolean;
  skipStrokes?: boolean;
  fillMaterial?: MeshPhongMaterialProps;
  strokeMaterial?: MeshPhongMaterialProps;
  fillMeshProps?: MeshProps;
  strokeMeshProps?: MeshProps;
}

const ReflectiveSvg = forwardRef<Object3D, SvgProps>(function R3FSvg(
  {
    src,
    skipFill,
    skipStrokes,
